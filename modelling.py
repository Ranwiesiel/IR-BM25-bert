...
tokenizer = BertTokenizer.from_pretrained('bert-base-indonesian')
model = BertModel.from_pretrained('bert-base-indonesian')
...
bm25_tokens = BM25Okapi(df['bm25_tokens'].tolist())
